<?php
    ...
    class User{
        ...
        public function emailExist($email){
            $stmp = $this->db->prepare("SELECT * FROM `users` WHERE `email` = :email");
        ...
        public function userData($userID = ''){
            ...
            $stmp = $this->db->prepare("SELECT * FROM `users` WHERE `userID` = :userID");
            $stmp->bindParam(":userID", $userID, PDO::PARAM_STR);
            $stmp->execute();
        ...
        public function getUserByUsername($username){
            $stmp = $this->db->prepare("SELECT * FROM `users` WHERE `username` = :username");
        ...
        public function getUserBySession($sessionID){
            $stmp = $this->db->prepare("SELECT * FROM `users` WHERE `sessionID` = :sessionID");
